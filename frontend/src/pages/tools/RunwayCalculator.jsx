        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 md:px-8">
          ...
          >
            ...
            <h1 className="text-3xl md:text-5xl font-bold mb-4"
              ...
              <span style={{ background: `linear-gradient(90deg, ${C.midCyan} 0%, ${C.brightCyan} 50%, ${C.midCyan} 100%)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Runway</span> Calculator
            </h1>
            <p className="text-base md:text-lg" style={{ color: C.textTertiary }}>
              See how long your cash will last and plan your fundraising timeline
            </p>
          </motion.div>
