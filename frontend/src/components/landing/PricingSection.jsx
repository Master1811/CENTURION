// PricingSection — Free + Founder only. No trial. No starter.
    ...
    >
      <motion.div className="relative h-full rounded-2xl overflow-hidden"
        style={{
          ...
          background: isPrimary
            ? `linear-gradient(145deg, rgba(184,150,46,0.18) 0%, rgba(5,10,16,0.92) 100%)`
            : 'rgba(5,15,24,0.72)',
          border: hov
            ? `1px solid ${accentColor}55`
            : isPrimary ? `1px solid ${accentColor}50` : `1px solid rgba(255,255,255,0.10)`,
      ...
      >
        ...
        <div className="absolute inset-x-0 top-0 h-px pointer-events-none"
          style={{ background: `linear-gradient(90deg, transparent, ${accentColor}${isPrimary ? '88' : '30'}, transparent)` }} />
        {children}
      </motion.div>
    </motion.div>
  );
        ...
        {plan.badge && (
          <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 z-10">
            <motion.span
              ...
              style={{
                background: isPrimary
                  ? `linear-gradient(135deg, ${C.gold}ee, ${C.goldLight}88)`
                  : `linear-gradient(135deg, ${C.brightCyan}cc, ${C.midCyan}88)`,
                color: C.darkCorner,
                boxShadow: `0 0 12px ${isPrimary ? C.gold : C.brightCyan}55`,
              }}
              animate={{ boxShadow: [
                `0 0 8px ${isPrimary ? C.gold : C.brightCyan}44`,
                `0 0 18px ${isPrimary ? C.gold : C.brightCyan}77`,
                `0 0 8px ${isPrimary ? C.gold : C.brightCyan}44`,
              ]}}
              transition={{ duration: 2.2, repeat: Infinity, ease: 'easeInOut' }}
            >
              {isPrimary ? <Crown className="w-3 h-3" strokeWidth={2.5} /> : <Zap className="w-3 h-3" strokeWidth={2.5} />}
              {plan.badge}
            </motion.span>
          </div>
        )}
        ...
        <div className="p-8 flex flex-col h-full" style={{ paddingTop: plan.badge ? '2.75rem' : '2rem' }}
          ...
          {plan.effectiveMonthly && (
            <p className="text-sm mb-6" style={{ color: 'rgba(255,255,255,0.42)' }}>
              {plan.effectiveMonthly} · Cancel anytime
            </p>
          )}
          {!plan.effectiveMonthly && <div className="mb-6" />}
          ...
          {isPrimary ? (
            <motion.button onClick={onCTA}
              ...
              style={{
                ...
                color: C.darkCorner,
                boxShadow: `0 0 0 1px rgba(184,150,46,0.35), 0 8px 28px rgba(184,150,46,0.28)`,
              }}
              whileHover={{ scale: 1.02, boxShadow: `0 0 0 1px rgba(184,150,46,0.50), 0 12px 36px rgba(184,150,46,0.36)` }}
              whileTap={{ scale: 0.97 }}
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none"
        style={{ backgroundImage: `radial-gradient(ellipse 70% 50% at 50% -5%, rgba(184,150,46,0.10) 0%, transparent 58%)` }} />
      <div className="absolute inset-0 pointer-events-none" style={{
        backgroundImage: `
          radial-gradient(ellipse 40% 40% at 5%  70%, rgba(0,96,128,0.12) 0%, transparent 55%),
          radial-gradient(ellipse 40% 40% at 95% 70%, rgba(0,96,128,0.12) 0%, transparent 55%)
        `,
      }} />
      {/* Vignettes */}
      <div className="absolute inset-0 pointer-events-none" style={{
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.07]" style={{
        backgroundImage: `radial-gradient(circle, rgba(184,150,46,0.6) 1px, transparent 1px)`,
      ...
      <div className="absolute top-0 inset-x-0 h-px pointer-events-none"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(184,150,46,0.14), transparent)' }} />
      <div className="absolute bottom-0 inset-x-0 h-px pointer-events-none"
        style={{ background: 'linear-gradient(90deg, transparent, rgba(184,150,46,0.10), transparent)' }} />
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-8">
        ...
        >
          <motion.span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase mb-5"
            style={{ background: 'rgba(184,150,46,0.10)', border: '1px solid rgba(184,150,46,0.28)', color: `${C.gold}cc`, letterSpacing: '0.14em' }}>
          ...
          <h2
            ...
            style={{
              background: `linear-gradient(135deg, #fff 35%, ${C.gold} 100%)`,
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
            }}
          >
            {copy.pricing.title}
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-10 items-start max-w-2xl mx-auto">
        ...
        >
          ...
          <span style={{ color: C.gold }}>Founder → Execute</span>
        </motion.div>
