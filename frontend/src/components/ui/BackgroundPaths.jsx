// BackgroundPaths - Animated SVG path background component
"use client";
...
export function BackgroundPaths({ title = "Background Paths", children }) {
  ...
  return (
    <div className="relative min-h-[400px] w-full flex items-center justify-center overflow-hidden rounded-2xl bg-white dark:bg-neutral-950">
