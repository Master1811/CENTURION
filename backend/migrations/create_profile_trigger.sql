-- ============================================================================
-- Profile Auto-Creation Trigger (Fixed for actual schema)
-- ============================================================================
...
-- Using only columns that definitely exist in the profiles table
...
INSERT INTO public.profiles (id, email, onboarding_completed, beta_status, created_at, updated_at)
SELECT
  u.id,
  u.email,
  FALSE,
