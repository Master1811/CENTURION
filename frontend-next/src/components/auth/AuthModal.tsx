            ...
            <div className="bg-slate-900 border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/10">
                <h2 className="text-xl font-semibold text-white">
                  {sent ? 'Check your email' : 'Get Started'}
                </h2>
                <button
                  onClick={handleClose}
              ...
              <div className="p-6">
                {sent ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-white mb-2">Magic link sent!</p>
                    <p className="text-white/60 text-sm">
                      Check your email at <strong className="text-white">{email}</strong> and click the link to sign in.
                    </p>
                    <Button
                      variant="ghost"
                      className="mt-6"
                  ...
                  <>
                    ...
                    <div className="relative my-6">
                      ...
                      <div className="relative flex justify-center text-sm">
                        <span className="px-4 bg-slate-900 text-white/50">or</span>
                      </div>
                    </div>
